...
class _CoursesExploreScreenState extends State<CoursesExploreScreen> {
  final List<String> categories = ["All", "Web Development", "Mobile", "AI", "Design"];
  ...
  void _filterCourses() {
    setState(() {
      filteredCourses = allCourses.where((course) {
        final nameMatches = course['title'].toString().toLowerCase().contains(searchQuery.toLowerCase());
        final categoryMatches = selectedCategory == "All" || course['category'] == selectedCategory;
    ...
    return SliverToBoxAdapter(
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            const Text("Explore\nCourses", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, height: 1.2)),
            const CircleAvatar(radius: 25, backgroundImage: AssetImage("assets/profileicon.png")),
          ],
        ),
      ),
    );
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(cat, style: TextStyle(color: isSelected ? Colors.white : Colors.black)),
                ),
              ),
            );
          },
  ...
  Widget _buildCourseGrid() {
    if (filteredCourses.isEmpty) {
      return const SliverToBoxAdapter(
        child: Center(child: Padding(padding: EdgeInsets.all(50), child: Text("No courses found."))),
      );
    }
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate(
          (context, index) {
            ...
            return CourseCard(course: course, isOwned: isOwned);
          },
        ...
        children: [
          Expanded(
            child: ClipRRect(
              ...
              child: Image.network( // Use Network image for backend data
                course['thumbnail'] ?? "",
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: isOwned ? Colors.blue : (price == 0 ? Colors.green : Colors.black),
